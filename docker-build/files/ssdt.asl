DefinitionBlock ("Ssdt.aml", "SSDT", 1, "REDHAT", "OVMF2   ", 1) {
    ...
    Device (\_SB.PCI0.SE0_) {
        Name (_ADR, 0x00010000)
    }

    Device (\_SB.PCI0.SE0_.S00_) {
        Name (_ADR, Zero)
  ...
  Scope (\_SB.PCI0.SE0_.S00_)
    {
        ...
        Method (_ROM, 2, Serialized)  // _ROM: Read-Only Memory
        {
            ...
            If (Local0 > RVBS)
            {
                Return (VROM) /* \_SB_.PCI0.SE0_.S00_._ROM.VROM */
            }
            ...
            If (Local4 == 0)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS1
            }
            ElseIf (Local4 == 1)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS2
            }
            ElseIf (Local4 == 2)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS3
            }
            ElseIf (Local4 == 3)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS4
            }
            ElseIf (Local4 == 4)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS5
            }
            ElseIf (Local4 == 5)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS6
            }
            ElseIf (Local4 == 6)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS7
            }
            ElseIf (Local4 == 7)
            {
                Local5 = \_SB.PCI0.SE0_.S00_.VBS8
            }
